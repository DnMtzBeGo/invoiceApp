...
const routes: Routes = [
  {
    ...
    loadChildren: () => import('./pages/map-dashboard/map-dashboard.module').then((m) => m.MapDashboardModule),
  },
  {
    path: 'calendar',
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/contact-support/contact-support.module').then((m) => m.ContactSupportModule)
  },
  ...
  {
    path: 'checkout',
    loadChildren: () => import('./pages/orders/components/checkout/checkout.module').then((m) => m.CheckoutModule)
  },
  {
    path: 'tracking',
