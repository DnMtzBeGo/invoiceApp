...
export class Step3Component implements OnInit {
  ...
  ngOnChanges(changes: SimpleChanges) {
    if (
      ...
      this.step3Form.get('fullname')!.setValue(changes.draftData.currentValue.dropoff.contact_info.name);
      this.step3Form.get('phonenumber')!.setValue(telephone);
      this.step3Form.get('email')!.setValue(changes.draftData.currentValue.dropoff.contact_info.email);
      this.step3Form.get('country_code')!.setValue(changes.draftData.currentValue.dropoff.contact_info.country_code);
